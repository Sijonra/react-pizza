...
const Sorting = props =>{
    ...
    return(
        <div onClick={()=>{setPopUpActive(!popUpActive)}} className={style.sorting}>
            ...
            <span>{sortCategories[props.activeCategory]}</span>
            {
                popUpActive ? (
                    <div className={style.sortPopUp}>
                        {
                            sortCategories.map((category, index)=>{
                                return(
                                    <p key={index} onClick={()=>{props.setActiveCategory(index)}}  className={props.activeCategory === index ? style.popUpActive : ''}>{category}</p>
                                )
                            })
                        }
                    </div>
